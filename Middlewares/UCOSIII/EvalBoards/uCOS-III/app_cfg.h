...
#define show_XY_name  show_TD

//===========汇誉协议选择显示==========//
#define show_HY   0    //显示汇誉(HY)
#define show_JG   1    //显示精工(JG)
#define show_YC   2    //显示YC-上海森通益虫 //IP地址固定写死，不能修改，
#define show_HYXY_name  show_JG

//===========备注==========
#define doguser    1    //0 = 关闭看门狗      1=开启看门狗
#define USE_645    0    //0 = 使用usart3打印  1=使用外部645
#define dwin_showversion  "240314"    //0x000A1112   其中第一个00  其它三个字节0A1112版本10.17.18      //方便查看240131--年月日
